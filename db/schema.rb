...
ActiveRecord::Schema.define(version: 20140223135028) do
  ...
  add_index "items", ["produto_id"], name: "index_items_on_produto_id"
  ...
  add_index "produtos", ["empresa_id"], name: "index_produtos_on_empresa_id"
